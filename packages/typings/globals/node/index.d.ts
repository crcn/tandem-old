...
declare module "tls" {
    ...
    export class TLSSocket extends stream.Duplex {
         ...
         * Smaller fragment size decreases buffering latency on the client: large dependencies are buffered by
         * the TLS layer until the entire fragment is received and its integrity is verified;
         * large dependencies can span multiple roundtrips, and their processing can be delayed due to packet
         * loss or reordering. However, smaller dependencies add extra TLS framing bytes and CPU overhead,
         * which may decrease overall server throughput.
         * @param {number} size - TLS fragment size (default and maximum value is: 16384, minimum is: 512).
         * @returns {boolean} - Returns true on success, false otherwise.
         */
        setMaxSendDependency(size: number): boolean;
    }
