...
class PathComponent extends React.Component {
    onPointDown(point, index, event) {
        ...
        index_1.startDrag(event, function (event2, info) {
            Object.assign(point, {
    ...
    render() {
        ...
        const w = x2 - x1 + cw;
        const h = y2 - y1 + cw;
        return (React.createElement("svg", {width: w, height: h, viewBox: [-cw / 2, -cw / 2, w, h]}, 
            React.createElement("path", {d: d, strokeWidth: strokeWidth, stroke: 'transparent', fill: 'transparent'}), 
            this.props.showPoints !== false ? points.map((path, key) => path.show !== false ?
                React.createElement("rect", {onMouseDown: this.onPointDown.bind(this, path, key), className: `point-circle-${path.id || key}`, strokeWidth: strokeWidth, stroke: 'black', fill: 'transparent', width: cr * 2, height: cr * 2, x: path.left - cr, y: path.top - cr, rx: 0, ry: 0, key: key})
                : void 0) : void 0));
    }
}
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = PathComponent;
