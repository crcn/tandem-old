...
const services_2 = require('saffron-core/src/services');
let IOService = class IOService extends services_2.BaseApplicationService {
    constructor(...args) {
        super(...args);
        /**
         */
        this.addConnection = (connection) => __awaiter(this, void 0, void 0, function* () {
            ...
            var remoteService = new services_1.Service();
    ...
    load() {
        ...
        // incomming actions
        this._publicService = new services_1.Service();
