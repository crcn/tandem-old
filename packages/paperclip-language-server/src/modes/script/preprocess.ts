...
function modifyPaperclipSource(sourceFile: ts.SourceFile): void {
  ...
  if (exportDefaultObject) {
    ...
    const vueImport = setZeroPos(
      ts.createImportDeclaration(
        undefined,
        undefined,
        setZeroPos(ts.createImportClause(ts.createIdentifier('__pcEditorBridge'), undefined as any)),
    ...
    const vue = ts.setTextRange(ts.createIdentifier('__pcEditorBridge'), {
