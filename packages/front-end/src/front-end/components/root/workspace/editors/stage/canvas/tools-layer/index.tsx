...
const BaseToolsLayerComponent = ({ editor, root, zoom, dispatch }: ToolsLayerComponent) => {
  ...
  return <div className="m-tools-layer">
    <InsertLayer editor={editor} toolType={root.toolType} dispatch={dispatch} window={activeWindow} />
    <DocumentsCanvasTool root={root} translate={editor.canvas.translate} dispatch={dispatch} editor={editor}  />
