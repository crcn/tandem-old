import { BaseExpression, ICursorPosition } from '../core/expression';
...
export class FunctionCallExpression extends BaseExpression {
  constructor(public reference:ReferenceExpression, public parameters:Array<BaseExpression>, public position:ICursorPosition) {
...
export class OperationExpression extends BaseExpression {
  constructor(public operator:string, public left:BaseExpression, public right:BaseExpression, public position:ICursorPosition) {
...
export class NegativeExpression extends BaseExpression {
  constructor(public value:BaseExpression, public position:ICursorPosition) {
...
export class NotExpression extends BaseExpression {
  constructor(public value:BaseExpression, position:ICursorPosition) {
...
export class TernaryExpression extends BaseExpression {
  constructor(public condition:BaseExpression, public left:BaseExpression, public right:BaseExpression, public position:ICursorPosition) {
