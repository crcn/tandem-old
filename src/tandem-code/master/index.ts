...
export const initializeMaster = async () => {
  ...
  const kernel = new Kernel(
    ...
    new CommandFactoryProvider(ExecuteCommandRequest.EXECUTE_COMMAND, ExecuteCommandCommand),
    ...
    new CommandFactoryProvider(UpdateUserSettingsRequest.UPDATE_USER_SETTINGS, UpdateUserSettingsCommand),
