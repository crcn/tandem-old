...
// import { CommandFactoryProvider, InitializeRequest, isMaster } from "@tandem/common";
...
//   new CommandFactoryProvider(InitializeRequest.INITIALIZE, InitializeHistoryCommand),
