...
export abstract class BaseEntity<T extends IASTNode> extends TreeNode<BaseEntity<any>> implements IEntity, IPatchable {
  ...
  public async loadExpressionAndInsertChildAt(childExpression: IASTNode, index: number) {
  ...
  public loadExpressionAndAppendChild(childExpression: IASTNode) {
  ...
  protected mapSourceChildren(): Array<IASTNode> {
    return <Array<IASTNode>>this.source.children;
  }
