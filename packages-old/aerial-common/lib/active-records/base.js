...
var BaseActiveRecord = /** @class */ (function (_super) {
    ...
    BaseActiveRecord.prototype.refresh = function () {
        return this.fetch(new mesh_ds7_1.DSFindRequest(this.collectionName, this.sourceQuery));
    };
    ...
    BaseActiveRecord.prototype.insert = function () {
        ...
        return this.fetch(new mesh_ds7_1.DSInsertRequest(this.collectionName, newData));
    };
    BaseActiveRecord.prototype.remove = function () {
        return this.fetch(new mesh_ds7_1.DSRemoveRequest(this.collectionName, this.sourceQuery));
    };
    ...
    BaseActiveRecord.prototype.update = function () {
        ...
        this.willSave();
        var newData = this.serialize();
        return this.fetch(new mesh_ds7_1.DSUpdateRequest(this.collectionName, newData, this.sourceQuery));
    };
    ...
    BaseActiveRecord.prototype.fetch = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mesh7_1.readOneChunk(this.dispatcher.dispatch(request))];
                    case 1:
