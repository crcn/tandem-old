...
function ipcSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.fork(receiveMessages)];
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.spawn(sendMessages)];
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(pingPong)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
                ...
                return [4 /*yield*/, effects_1.spawn(function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!1) return [3 /*break*/, 2];
                                    return [4 /*yield*/, effects_1.take("$$PONG")];
                                case 1:
                                    _a.sent();
                                    _ponged = true;
                                    return [3 /*break*/, 0];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    _ponged = false;
                                    return [4 /*yield*/, effects_1.put({ type: "$$PING", $public: true })];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.call(redux_saga_1.delay, 1000 * 20)];
                                case 2:
                                    _a.sent();
                                    if (!_ponged) {
