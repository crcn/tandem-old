...
var transitionProps = [
    ...
    'leave-active-class',
    'appear-active-class'
].map(function (t) { return common_1.genAttribute(t); }));
var vueTags = {
    ...
    'keep-alive': new common_1.HTMLTagSpecification('When wrapped around a dynamic component, <keep-alive> caches the inactive component instances without destroying them.', ['include', 'exclude'].map(function (t) { return common_1.genAttribute(t); })),
...
function getVueTagProvider() {
    return {
        getId: function () { return 'vue'; },
        priority: common_1.Priority.Framework,
        collectTags: function (collector) { return common_1.collectTagsDefault(collector, vueTags); },
