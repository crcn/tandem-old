...
import {
  RenderedClientRects,
  RenderedComputedStyleDeclarations,
  SEnvWindowInterface
} from "../environment";
...
export const TOGGLE_CSS_DECLARATION_PROPERTY =
  "TOGGLE_CSS_DECLARATION_PROPERTY";
export const SYNTHETIC_WINDOW_RESOURCE_LOADED =
  "SYNTHETIC_WINDOW_RESOURCE_LOADED";
export const NEW_SYNTHETIC_WINDOW_ENTRY_RESOLVED =
...
export const SYNTHETIC_NODE_TEXT_CONTENT_CHANGED =
...
export const SYNTHETIC_WINDOW_RESOURCE_CHANGED =
...
export type OpenPaperclipStateWindow = {
...
export const mutateSourceContentRequest = (
  content: string,
  contentType: string,
  mutation: Mutation<any>
): MutateSourceContentRequest<any> => ({
  content,
  mutation,
  contentType,
...
export const toggleCSSDeclarationProperty = (
  propertyName: string,
  cssDeclarationId: string,
  windowId: string
...
export const mutateSourceContentRequest2 = (
  mutations: Mutation<any>[]
): MutateSourceContentRequest2<any> => ({
  mutations: mutations.map(mutation => ({
    ...mutation,
    target: { source: mutation.target.source },
    child: (mutation as any).child && { source: (mutation as any).child.source }
  })),
  $id: generateDefaultId(),
...
export const syntheticWindowProxyOpened = (
  instance: SEnvWindowInterface,
  parentWindowId?: string,
  isNew?: boolean
): SyntheticWindowOpened => ({
...
export const syntheticWindowMoved = (
  instance: SEnvWindowInterface
...
export const syntheticWindowClosed = (
  instance: SEnvWindowInterface
): SyntheticWindowChanged => ({
  instance,
...
export const syntheticWindowResized = (
  instance: SEnvWindowInterface
): SyntheticWindowChanged => ({
  instance,
...
export const syntheticWindowResourceChanged = (
  uri: string
...
export const applyFileMutationsRequest = (
  ...mutations: Mutation<any>[]
): ApplyFileMutations => ({
  mutations,
  $id: generateDefaultId(),
...
export const deferApplyFileMutationsRequest = (
  ...mutations: Mutation<any>[]
): ApplyFileMutations => ({
  mutations,
  $id: generateDefaultId(),
...
export const testMutateContentRequest = (
  contentType: string,
  mutationType?: string
) => (action: MutateSourceContentRequest<any>) =>
  action.type === EDIT_SOURCE_CONTENT &&
  action.contentType === contentType &&
  (!mutationType || action.mutation.$type === mutationType);

export const syntheticNodeValueStoppedEditing = (
  syntheticWindowId: string,
  nodeId: string
...
export const syntheticWindowScrolled = (
  syntheticWindowId: string,
  scrollPosition: Point
...
export const syntheticWindowScroll = (
  syntheticWindowId: string,
  scrollPosition: Point
...
export const syntheticNodeTextContentChanged = (
  syntheticWindowId: string,
  syntheticNodeId: string,
  textContent: string
...
export const openSyntheticWindowRequest = (
  state: Partial<SyntheticWindow>,
  PaperclipStateId?: string,
...
export const newSyntheticWindowEntryResolved = (
  location: string,
  PaperclipStateId?: string
...
export const syntheticWindowRectsUpdated = (
  syntheticWindowId: string,
  rects: RenderedClientRects,
  styles: RenderedComputedStyleDeclarations
...
export const syntheticWindowResourceLoaded = (
  syntheticWindowId: string,
  uri: string
...
export const syntheticWindowLoaded = (
  instance: SEnvWindowInterface
...
export const syntheticWindowChanged = (
  instance: SEnvWindowInterface
): SyntheticWindowLoaded => ({
  instance,
