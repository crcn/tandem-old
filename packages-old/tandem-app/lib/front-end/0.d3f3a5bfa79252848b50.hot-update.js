...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = ".TdWindowsPaneRow.host {cursor:  pointer;}"
...
const hydrateTdWindowsPaneRow = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  const { document, location, onClick, $id } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "TdWindowsPaneRow host", "data-document": document ? true : null, "data-location": location ? true : null, "data-onClick": onClick ? true : null, "data-$id": $id ? true : null },   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", {"onClick": (onWindowClicked),"className": "TdWindowsPaneRow",}, document && document.title || "Loading..."));});
};
