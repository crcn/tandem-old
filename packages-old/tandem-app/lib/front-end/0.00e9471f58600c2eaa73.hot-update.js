...
var inferExprType = function (expr, context) {
    switch (expr.type) {
        ...
        case ast_1.BKExpressionType.OPERATION: {
            ...
            // reset optional flag to parent -- right most side cannot
            // be optional since it's the fallback.
            console.log(previousTypeLimit & InferenceType.OPTIONAL, (previousTypeLimit & InferenceType.OPTIONAL || InferenceType.OPTIONAL), newTypeLimit);
            context = inferExprType(right, operator !== "===" ? setTypeLimit(newTypeLimit & ~(previousTypeLimit & InferenceType.OPTIONAL || InferenceType.OPTIONAL), "The right-hand side of an arithmetic operation must be " + exports.getPrettyTypeLabelEnd(context.typeLimit), context) : context);
            return context;
        }
...
var reduceInferenceType = function (expr, keyPath, context) {
    var newTypeLimit = (getContextInferenceType(keyPath, context) | InferenceType.OPTIONAL) & context.typeLimit;
    if (!exports.isValidReturnType(newTypeLimit, context)) {
