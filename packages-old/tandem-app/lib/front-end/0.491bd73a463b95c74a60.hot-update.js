...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = "* {box-sizing:  border-box;} :root {--base:  2px;--base2:  4px;--base3:  6px;--base4:  8px;--base6:  10px;--base8:  12px;--base10:  14px;--base11:  16px;--font-size-rg:  12px;--font-size-md:  18px;--font-size-lg:  24px;--font-size-sm:  8px;--font-color:  #777;--font-color-alt:  #999;--font-color-dim:  #CCC;--font-color-light:  rgba(255, 255, 255, 0.9);--font-color-invert:  rgba(255, 255, 255, 0.9);--background:  #FEFEFE;--background-alt:  #F9F9F9;--border-color:  #ECECEC;--border-color-deep:  #D9D9D9;--background-accent:  #F4F4F4;--background-deep:  #E9E9E9;--background-bold:  #EFEFEF;--background-highlight:  #00B5FF;--background-overlay:  rgba(255, 255, 255, 0.7);} body, html {font-family:  Helvetica;margin:  0;padding:  0;font-size:  var(--font-size-rg);color:  var(--font-color);}"
...
const hydrateTdPlayer = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdPlayer host" }, __getDataProps(props)),   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("svg", {"className": "TdPlayer",}, ));});
};
...
const hydrateTdList = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  const { children } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdList host" }, __getDataProps(props)),   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", {"className": "TdList",}, children));});
};
...
const hydrateTdPreviewComponentExample = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  const { label, children } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdPreviewComponentExample host" }, __getDataProps(props)),   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h3", {"className": "TdPreviewComponentExample",}, label),children);});
};
...
if (typeof document != "undefined") {
  (() => {
    const style = document.createElement("style");
    style.textContent = ".TdListItem.host {background:  var(--background);border-bottom:  1px solid var(--border-color);padding:  var(--base6) var(--base8);display:  block;} .TdListItem.host[nopadding] {padding:  0;} .TdListItem.host:last-child {border-bottom:  0;} .TdListItem.host:nth-child(2n) {background:  var(--background-alt);} .TdListItem.host[selected] {background:  red;}"
...
const hydrateTdListItem = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  const { children } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdListItem host" }, __getDataProps(props)),   children);});
};
...
const hydrateTdProgress = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  const { value, children } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdProgress host" }, __getDataProps(props)),   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", {"className": "TdProgress " + "background",}, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", {"className": "TdProgress " + "fill","style": ({width:value * 100 + "%", }),}, ), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", {"className": "TdProgress",}, children)));});
};
...
const hydrateTdBanner = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  const { children } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdBanner host" }, __getDataProps(props)),   children);});
};
...
const hydrateTdProgressExample = (enhance, hydratedChildComponentClasses = {}) => {
  ...
  const childComponentClasses = defaults(baseComponentClasses, hydratedChildComponentClasses);  return enhance((props) => {  const { value } = props;  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdProgressExample host" }, __getDataProps(props)),   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](childComponentClasses.TdProgress, {"value": (value),}, value * 100, "%"));});
};
