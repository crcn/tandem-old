...
exports.artboardDiffed = function (artboardId, diffs, nativeNodeMap) { return ({
...
var artboardReducer = function (state, event) {
    switch (event.type) {
        ...
        case actions_1.ARTBOARD_DIFFED: {
            var _b = event, artboardId = _b.artboardId, diffs = _b.diffs, nativeNodeMap = _b.nativeNodeMap;
            var artboard = state_1.getArtboardById(artboardId, state);
            var document_2 = slim_dom_1.patchNode(artboard.originalDocument, diffs);
            return state_1.updateArtboard(state, artboardId, {
                document: document_2,
                nativeNodeMap: nativeNodeMap,
                originalDocument: document_2,
