...
var lintStartTagAttributes = function (startTag, context) {
    ...
    for (var propertyName in attributesByKey) {
        ...
        var attrValueInference = getAttributeValueInference(attribute, context);
...
var addDiagnosticError = function (expr, message, context) { return addDiagnostic(expr, parser_utils_1.DiagnosticType.ERROR, message, true, context); };
var addDiagnostic = function (expr, type, message, shouldBreak, context) {
    return __assign({}, context, { shouldBreak: shouldBreak, diagnostics: context.diagnostics.concat([
            {
...
var getAttributeValueInference = function (attribute, context) {
    if (!attribute.value) {
        return true;
    }
