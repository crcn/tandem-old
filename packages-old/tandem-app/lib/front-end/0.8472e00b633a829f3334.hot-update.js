...
function handleFileRemoved() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _loop_1 = function () {
                    var state, workspace, availableComponentUris, browser, windowUris, deletes;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                deletes = source_mutation_1.diffArray(windowUris, availableComponentUris, function (a, b) { return a === b ? 0 : -1; }).mutations.map(function (mutation) { return mutation.type === source_mutation_1.ARRAY_DELETE; });
                                console.log("DEL", deletes, windowUris, availableComponentUris);
