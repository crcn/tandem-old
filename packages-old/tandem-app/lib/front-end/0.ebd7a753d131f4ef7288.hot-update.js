...
var diff_patch_1 = __webpack_require__("../slim-dom/lib/diff-patch.js");
...
exports.patchDOM = function (diffs, map, container) {
    for (var i = 0, length_5 = diffs.length; i < length_5; i++) {
        ...
        var target = map[mutation.target];
        console.log(mutation.type, target, diff_patch_1.SET_TEXT_NODE_VALUE);
