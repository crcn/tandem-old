...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = ".TdWindowsPaneRow.host {cursor:  pointer;width:  100%;display:  inline-block;padding:  10px 10px;} .TdWindowsPaneRow.host[data-selected] {background:  var(--background-highlight);color:  var(--font-color-invert);}"
