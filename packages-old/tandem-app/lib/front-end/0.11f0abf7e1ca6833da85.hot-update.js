...
var lintElement = function (element, context) {
    ...
    if (_repeat) {
        ...
        eachValue(context.currentExprValue, function (item, index) {
            context = lintStartTagAttributes(startTag, pushCaller(_repeat, currentFilePath_1, (_a = {},
    ...
    switch (expr.type) {
        ...
        case ast_1.BKExpressionType.VAR_REFERENCE: {
            ...
            if (context.caller) {
                ...
                // console.log(keypath, value, context.currentComponentId, context.caller);
                if (value === undefined && (keypath.length > 1 || !context.optionalVars)) {
                    console.log(context.optionalVars);
                ...
                context = setCurrentExprValue(null, context);
            }
            return context;
        }
        case ast_1.BKExpressionType.OBJECT: {
            ...
            for (var i = 0, length_8 = object.properties.length; i < length_8; i++) {
                ...
                objValue[key] = context.currentExprValue;
            }
            context = setCurrentExprValue(objValue, context);
            return context;
        }
