...
function handleFileRemoved() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _loop_1 = function () {
                    var publicPath, state, browser, matchingWindow;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                matchingWindow = browser.windows.find(function (window) { return window.location.indexOf(publicPath) !== -1; });
                                console.log("FILE REMOVED", matchingWindow);
                                if (matchingWindow) {
                                    matchingWindow.instance.close();
                                }
