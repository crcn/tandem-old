...
const hydrateTdColorPicker = (enhance, hydratedChildComponentClasses = {}) => {
  return enhance((props) => {  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", Object.assign({ className: "TdColorPicker host" }, __getDataProps(props)),   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", {"className": "TdColorPicker " + "hue-saturation-picker",}, "HSLLLL"));});
};
