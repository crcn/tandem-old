...
exports.apiOpenSourceFile = function (componentId, previewName, checksum, path, state) { return __awaiter(_this, void 0, void 0, function () {
    var response, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch(state.textEditorHost + "/open", {
                    method: "POST",
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json"
