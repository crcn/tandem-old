...
exports.textEditorChanged = function (file, value) { return ({ type: exports.TEXT_EDITOR_CHANGED, file: file, value: value }); };
...
var text_editor_1 = __webpack_require__("./src/front-end/components/main/workspace/text-editor/index.tsx");
...
exports.WorkspaceBase = function (_a) {
    ...
    return React.createElement("div", { className: "workspace-component" },
        ...
        React.createElement("div", { className: "workspace-editors" },
            stage.showTextEditor ? React.createElement(text_editor_1.TextEditor, { file: state_1.getSelectedWorkspaceFile(state, workspace), cursorPosition: workspace.textEditor.cursorPosition, dispatch: dispatch }) : null,
...
exports.ProjectGutterBase = function (_a) {
    ...
    return React.createElement(enhanced_1.Gutter, { left: true, right: false },
        React.createElement(enhanced_1.WindowsPane, { windows: browser.windows || [] }),
...
exports.TextEditorBase = function (_a) {
    ...
    return React.createElement("div", { className: "text-editor-component" },
        React.createElement(CodeMirror, { ref: setCodeMirror, options: {
            ...
            }, onChange: function (value) { return dispatch(actions_1.textEditorChanged(file, value)); } }));
};
...
exports.applicationReducer = function (state, event) {
    ...
    state = aerial_sandbox2_1.fileCacheReducer(state, event);
...
var componentsPaneReducer = function (state, event) {
    switch (event.type) {
        case front_end_1.COMPONENTS_PANE_COMPONENT_CLICKED: {
            var componentId = event.componentId;
            return state_1.setWorkspaceSelection(state, state.selectedWorkspaceId, aerial_common2_1.getStructReference({ $id: componentId, $type: front_end_1.AVAILABLE_COMPONENT }));
        }
    }
    return state;
};
...
var stageReducer = function (state, event) {
    switch (event.type) {
        ...
        case actions_1.RESIZER_MOUSE_DOWN: {
            var _e = event, sourceEvent = _e.sourceEvent, workspaceId = _e.workspaceId;
            var metaKey = sourceEvent.metaKey || sourceEvent.ctrlKey;
            var workspace = state_1.getWorkspaceById(state, workspaceId);
...
var setSelectedFileFromNodeId = function (state, workspaceId, nodeId) {
    var _a = aerial_browser_sandbox_1.getSyntheticNodeById(state, nodeId).source, uri = _a.uri, start = _a.start;
    var fileCacheItem = aerial_sandbox2_1.getFileCacheItemByUri(state, uri);
    if (fileCacheItem) {
        state = state_1.updateWorkspace(state, workspaceId, {
            selectedFileId: fileCacheItem.$id,
        });
        state = state_1.updateWorkspaceTextEditor(state, workspaceId, {
            cursorPosition: start
        });
        return state_1.showWorkspaceTextEditor(state, workspaceId);
    }
    return state;
};
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, effects_1.take([actions_1.FILE_CONTENT_CHANGED, actions_1.COMPONENT_SCREENSHOT_SAVED])];
            case 5:
                // just refresh whenever a file has changed
                _a.sent();
                return [3 /*break*/, 0];
        ...
        switch (_a.label) {
            case 0:
                _loop_2 = function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, effects_1.take(actions_1.FILE_CONTENT_CHANGED)];
                            case 1:
                            ...
                            case 2:
                                ...
                                for (_i = 0, windows_1 = windows; _i < windows_1.length; _i++) {
                                    ...
                                    if (shouldReload) {
                                        console.log("Reloading window ", window_2.location);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                window_3 = _a[_i];
                return [4 /*yield*/, effects_1.put(aerial_browser_sandbox_1.openSyntheticWindowRequest(window_3, browser.$id, true))];
            case 4:
                _b.sent();
                _b.label = 5;
            case 5:
...
function mainWorkspaceSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 10:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(handleTextEditorChange)];
            case 11:
                _a.sent();
...
function handleTextEditorChange() {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (false) return [3 /*break*/, 3];
                return [4 /*yield*/, effects_1.take(actions_1.TEXT_EDITOR_CHANGED)];
            case 1:
                _a = (_b.sent()), value = _a.value, file = _a.file;
                return [4 /*yield*/, effects_1.put(aerial_sandbox2_1.uriCacheBusted(file.sourceUri, value, file.contentType))];
            case 2:
                _b.sent();
                return [3 /*break*/, 0];
            case 3: return [2 /*return*/];
...
var serializeStage = function (_a) {
    var showTextEditor = _a.showTextEditor, showRightGutter = _a.showRightGutter, showLeftGutter = _a.showLeftGutter, showTools = _a.showTools, translate = _a.translate;
    return ({
        panning: false,
        translate: translate,
