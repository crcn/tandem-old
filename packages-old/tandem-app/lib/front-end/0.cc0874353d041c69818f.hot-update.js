...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = ".TdStyleDeclaration.host[ignored] {opacity:  0.2;} .TdStyleDeclaration.host[data-overridden] span.TdStyleDeclaration {text-decoration:  line-through;color:  var(--font-color-dim);} .name.TdStyleDeclaration {color:  var(--font-color-dim);} .name.TdStyleDeclaration::after {content:  \": \";}"
...
const hydrateTdStyleDeclaration = (enhance, hydratedChildComponentClasses = {}) => {
  ...
  const childComponentClasses = defaults(baseComponentClasses, hydratedChildComponentClasses);  return enhance((props) => {  const { name, overridden, value, sourceValue } = props;  let conditionPassed_1;return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "TdStyleDeclaration host", "data-name": name ? true : null, "data-overridden": overridden ? true : null, "data-value": value ? true : null, "data-sourceValue": sourceValue ? true : null },   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", {"className": "TdStyleDeclaration " + "name",}, name),!conditionPassed_1 && (!overridden) && (conditionPassed_1 = true) ? __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](childComponentClasses.TdCssExprInput, {"value": (value),}, ) : null,!conditionPassed_1 && (true) && (conditionPassed_1 = true) ? __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", {"className": "TdStyleDeclaration",}, sourceValue) : null);});
};
...
const hydrateCssInspectorMultipleItemsSelected = (enhance, hydratedChildComponentClasses = {}) => {
  ...
  const childComponentClasses = defaults(baseComponentClasses, hydratedChildComponentClasses);  return enhance((props) => {  return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "CssInspectorMultipleItemsSelected host",  },   __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](childComponentClasses.TdPane, {"headerSlot": __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", {"className": "CssInspectorMultipleItemsSelected",}, "CSS Inspector"),"contentSlot": __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", {"className": "CssInspectorMultipleItemsSelected " + "content",}, "Please select only one element to edit CSS \n        properties."),}, ));});
};
