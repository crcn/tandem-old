...
(function (InferenceType) {
    ...
    InferenceType[InferenceType["ANY"] = 63] = "ANY";
...
var inferExprType = function (expr, context) {
    switch (expr.type) {
        ...
        case ast_1.BKExpressionType.PROP_REFERENCE: {
            return reduceInferenceType(expr, exports.getReferenceKeyPath(expr), context);
        }
...
var addInvalidTypeError = function (expr, type, context) { return addDiagnosticError(expr, context, "Type mismatch " + type + " to " + context.typeLimit); };
...
var addDiagnostic = function (expr, level, context, defaultMessage) { return (__assign({}, context, { diagnostics: context.diagnostics.concat([{
