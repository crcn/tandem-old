...
exports.getDocumentPreviewDiff = function (componentId, previewName, checksum, state) { return __awaiter(_this, void 0, void 0, function () {
    var uri, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                uri = state.apiHost + "/components/" + componentId + "/preview";
