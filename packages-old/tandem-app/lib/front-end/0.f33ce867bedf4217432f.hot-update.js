...
var lintElement = function (element, context) {
    ...
    if (_repeat) {
        ...
        eachValue(context.currentExprEvalResult.value, function (item, index) {
            context = lintStartTagAttributes(startTag, pushCaller(eachValueSource_1, currentFilePath_1, __assign({}, (context.caller && context.caller.props || {}), (_a = {}, _a[asValueName_1] = item, _a[asKeyName_1] = asKey_1 ? { value: index, source: asKey_1 } : null, _a)), context));
