    ...
    switch (expr.type) {
        ...
        case ast_1.BKExpressionType.VAR_REFERENCE: {
            ...
            if (context.caller) {
                ...
                var componentInference = (component && inferencing_1.inferNodeProps(component.source)) || inferencing_1.ANY_REFERENCE;
                ...
                else if (componentInference) {
                    console.log(componentInference);
                }
            }
            return context;
        }
