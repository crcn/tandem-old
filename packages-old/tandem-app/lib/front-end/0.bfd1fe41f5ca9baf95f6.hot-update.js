                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, effects_1.spawn(function () {
                                        var _this = this;
                                        var state, p, emitChange, curl_1, buffer;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, effects_1.select()];
                                                case 1:
                                                    ...
                                                    if (_pending[uri]) {
                                                        ...
                                                        if (state.fileCache && state.fileCache[uri]) {
                                                            ...
                                                            curl_1 = uri;
                                                            if (curl_1.charAt(0) === "/") {
                                                                curl_1 = window.location.protocol + "//" + window.location.host + curl_1;
                                                            }
                                                            if (curl_1.indexOf(window.location.host) === -1) {
                                                                curl_1 = state.apiHost + "/proxy/" + encodeURIComponent(String(info));
                                                            }
                                                            p = _pending[uri] = new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                                                                var response, blob, fr;
                                                                return __generator(this, function (_a) {
                                                                    switch (_a.label) {
                                                                        case 0: return [4 /*yield*/, fetch(curl_1)];
                                                                        case 1:
                                                                            response = _a.sent();
                                                ...
                                                case 2:
                                                    buffer = _a.sent();
                                                    if (!emitChange) return [3 /*break*/, 4];
                                                    return [4 /*yield*/, effects_1.put(actions_1.fetchedContent(uri, buffer))];
                                                case 3:
                                                    _a.sent();
                                                    _a.label = 4;
                                                case 4:
                                                    _pending[uri] = undefined;
                                                    return [4 /*yield*/, effects_1.put(aerial_common2_1.createRequestResponse(req.$id, buffer))];
                                                case 5:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
                ...
                return [4 /*yield*/, effects_1.spawn(function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _loop_2 = function () {
                                        var _a, info, resolve, buffer, text;
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0: return [4 /*yield*/, effects_1.call(fetchQueue.next)];
                                                case 1:
...
function handleOpenedSyntheticWindow() {
    function updateProxy(window, isNew) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.put(actions_1.syntheticWindowProxyOpened(proxy, undefined, isNew))];
                case 4:
                    _c.sent();
                    return [3 /*break*/, 6];
                case 5:
    ...
    var proxies, createRenderer, _a, instance, isNew;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                proxies = new Map();
            ...
            case 2:
                _a = (_b.sent()), instance = _a.instance, isNew = _a.isNew;
                return [4 /*yield*/, effects_1.call(updateProxy, instance, isNew)];
            case 3:
                _b.sent();
                return [3 /*break*/, 1];
            case 4: return [2 /*return*/];
            ...
            case 0:
                ...
                chan = redux_saga_1.eventChannel(function (emit) {
                    ...
                    window.addEventListener(SEnvWindowOpenedEvent.WINDOW_OPENED, function (event) {
                        emit(actions_1.syntheticWindowOpened(event.window, window.$id, true));
                    });
                    window.addEventListener("scroll", function (event) {
                        emit(actions_1.syntheticWindowScrolled(window.$id, {
                            left: window.scrollX,
