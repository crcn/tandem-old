...
function mainWorkspaceSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 19:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(handleFileRemoved)];
            case 20:
                _a.sent();
                return [2 /*return*/];
        }
...
function handleFileRemoved() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("HAN FILE REMOVED");
                _loop_1 = function () {
                    var publicPath, state, browser, matchingWindows, _i, matchingWindows_1, window_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, effects_1.take(actions_1.FILE_REMOVED)];
                            case 1:
                                publicPath = (_a.sent()).publicPath;
                                return [4 /*yield*/, effects_1.select()];
                            case 2:
                                state = _a.sent();
                                browser = aerial_browser_sandbox_1.getSyntheticBrowser(state, state_1.getWorkspaceById(state, state.selectedWorkspaceId).browserId);
                                matchingWindows = browser.windows.filter(function (window) { return window.location.indexOf(publicPath) !== -1; });
                                console.log("FILE REMOVED", matchingWindows);
                                for (_i = 0, matchingWindows_1 = matchingWindows; _i < matchingWindows_1.length; _i++) {
                                    window_3 = matchingWindows_1[_i];
