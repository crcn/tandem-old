...
var lintStartTagAttributes = function (startTag, context) {
    ...
    console.log("ENTER", startTag.name, ignoreTagName("preview", pushCaller(startTag, filePath, props, setCurrentComponentId(startTag.name, context))));
    ...
    console.log("EXIT", startTag.name);
