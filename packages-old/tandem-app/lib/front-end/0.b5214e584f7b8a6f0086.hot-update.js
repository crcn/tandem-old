...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = ".TdWindowsPaneRow.host {cursor:  pointer;width:  100%;display:  inline-block;padding:  var(--base6) var(--base8);} .TdWindowsPaneRow.host[data-selected] {background:  var(--background-highlight);color:  var(--font-color-invert);}"
