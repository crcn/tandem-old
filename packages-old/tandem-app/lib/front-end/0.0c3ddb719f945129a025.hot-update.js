...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = ".TdWindowsPaneRow.host {cursor:  pointer;display:  inline-block;width:  100%;padding:  var(--base6) var(--base8);} .TdWindowsPaneRow.host[data-selected] {background:  var(--background-highlight);color:  var(--font-color-invert);} div.TdWindowsPaneRow {display:  inline-block;width:  100%;user-select:  none;}"
