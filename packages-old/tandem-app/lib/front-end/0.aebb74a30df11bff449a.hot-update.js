            ...
            case 0: return [4 /*yield*/, effects_1.spawn(function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                diffs = _a.sent();
                                console.log("PATCH", diffs.map(function (diff) { return diff.type; }));
                                // TODO - patch DOM nodes here
                                return [4 /*yield*/, effects_1.put(actions_1.artboardDiffed(artboard.$id, diffs, slim_dom_1.patchDOM(diffs, artboard.nativeNodeMap, artboard.mount)))];
                            case 3:
                                // TODO - patch DOM nodes here
                                _a.sent();
                                return [2 /*return*/];
