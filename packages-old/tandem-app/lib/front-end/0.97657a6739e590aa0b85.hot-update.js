...
var tranpsileComponent = function (_a, context) {
    ...
    previews.forEach(function (preview) {
        var name = ast_1.getPCStartTagAttribute(preview, "name");
        var child = preview.childNodes.find(function (child) { return child.type === ast_1.PCExpressionType.SELF_CLOSING_ELEMENT || child.type === ast_1.PCExpressionType.ELEMENT; });
        if (!child) {
            return;
        }
