...
if (typeof document != "undefined") {
  (() => {
    const style = document.createElement("style");
    style.textContent = ".TdListItem.host[selected] {background:  red;} .TdListItem.host {background:  var(--background);border-bottom:  1px solid var(--border-color);padding:  var(--base6) var(--base8);display:  block;} .TdListItem.host:last-child {border-bottom:  0;} .TdListItem.host:nth-child(2n) {background:  var(--background-alt);}"
