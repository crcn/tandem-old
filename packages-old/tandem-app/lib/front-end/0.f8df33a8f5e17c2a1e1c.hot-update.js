...
var ICON_SIZE = 110;
var enhanceComponentsPaneCell = recompose_1.compose(recompose_1.pure, recompose_1.withState("previewImage", "setPreviewImage", function (props) {
    if (props.screenshots.length) {
        var screenshot = props.screenshots[0];
        var image_1 = new Image();
        image_1.src = "/components/" + props.tagName + "/screenshots/" + screenshot.previewName + "/latest.png";
        image_1.onload = function () {
            console.log("LOADED", image_1.src);
        };
        return image_1;
    }
}), state_1.withDragSource({
    getData: function (_a) {
    ...
    start: function (props) { return function (event) {
        if (props.previewImage) {
            ...
            event.dataTransfer.setDragImage(props.previewImage, 0, 0);
            props.previewImage.onload = function () {
            };
        }
    }; }
