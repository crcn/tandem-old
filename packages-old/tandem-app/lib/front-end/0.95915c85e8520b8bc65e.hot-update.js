...
/***/ "../aerial-browser-sandbox/lib/actions/index.js":
...
exports.syntheticWindowOpened = function (instance, browserId, parentWindowId) { return ({
    parentWindowId: parentWindowId,
    browserId: browserId,
    instance: instance,
    type: exports.SYNTHETIC_WINDOW_OPENED
}); };
exports.syntheticWindowProxyOpened = function (instance, browserId, parentWindowId) { return ({
    parentWindowId: parentWindowId,
    browserId: browserId,
    instance: instance,
...
function syntheticBrowserSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.fork(handleBrowserChanges)];
            case 1:
                _a.sent();
...
function handleBrowserChanges() {
    var runningSyntheticBrowserIds;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                runningSyntheticBrowserIds = [];
                return [4 /*yield*/, aerial_common2_1.watch(function (root) { return state_1.getSyntheticBrowsers(root); }, function (browsers) {
                        var syntheticBrowserIds;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    syntheticBrowserIds = browsers.map(function (item) { return item.$id; });
                                    return [5 /*yield**/, __values(lodash_1.difference(syntheticBrowserIds, runningSyntheticBrowserIds).map(function (id) { return (effects_1.spawn(handleSyntheticBrowserSession, id)); }))];
                                case 1:
                                    _a.sent();
...
function handleSyntheticBrowserSession(syntheticBrowserId) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.fork(handleOpenSyntheticWindow, syntheticBrowserId)];
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(handleOpenedSyntheticWindow, syntheticBrowserId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(handleOpenedSyntheticProxyWindow, syntheticBrowserId)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
function handleOpenSyntheticWindow(browserId) {
    var request_1, instance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (false) return [3 /*break*/, 3];
                return [4 /*yield*/, effects_1.take(function (action) { return action.type === actions_1.OPEN_SYNTHETIC_WINDOW && action.syntheticBrowserId === browserId; })];
            case 1:
                request_1 = (_a.sent());
                return [4 /*yield*/, effects_1.call(openSyntheticWindowEnvironment, request_1.state, browserId)];
            case 2:
                instance = (_a.sent());
                return [3 /*break*/, 0];
            case 3: return [2 /*return*/];
            ...
            case 2:
                ...
                return [4 /*yield*/, redux_saga_1.eventChannel(function (emit) {
                        var reload = function (bounds) {
                            ...
                            var window = currentWindow = new SEnvWindow(location);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    currentWindow.$load();
                                    return [4 /*yield*/, effects_1.put(actions_1.syntheticWindowOpened(currentWindow, browserId))];
                                case 2:
                                    _a.sent();
...
function handleOpenedSyntheticWindow(browserId) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, effects_1.call(getBestWindowPosition, browserId, function (existingWindow) { return existingWindow.$id !== window.$id; })];
                case 2:
                    _a = (_c.sent());
                    _c.label = 3;
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.put(actions_1.syntheticWindowProxyOpened(proxy, browserId))];
                case 4:
                    _c.sent();
                    return [3 /*break*/, 6];
                case 5:
...
function handleOpenedSyntheticProxyWindow(browserId) {
    var _loop_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _loop_2 = function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                instance = (_a.sent()).instance;
                                return [4 /*yield*/, effects_1.spawn(handleSyntheticWindowInstance, instance, browserId)];
                            case 2:
                                thread = _a.sent();
...
function handleSyntheticWindowInstance(window, browserId) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.fork(handleSyntheticWindowEvents, window, browserId)];
            case 1:
                _a.sent();
...
function handleSyntheticWindowEvents(window, browserId) {
            ...
            case 0:
                ...
                chan = redux_saga_1.eventChannel(function (emit) {
                    ...
                    window.addEventListener(SEnvWindowOpenedEvent.WINDOW_OPENED, function (event) {
                        emit(actions_1.syntheticWindowOpened(event.window, browserId, window.$id));
                    });
                    window.addEventListener("scroll", function (event) {
                        emit(actions_1.syntheticWindowScrolled(window.$id, {
                            left: window.scrollX,
