...
var lintElement = function (element, context) {
    ...
    if (_repeat) {
        ...
        eachValue(context.currentExprEvalResult.value, function (item, index) {
            context = lintStartTagAttributes(startTag, pushCaller(eachValueSource_1, currentFilePath_1, __assign({}, (context.caller && context.caller.props || {}), (_a = {}, _a[asValueName_1] = item, _a)), context));
        ...
        case ast_1.BKExpressionType.VAR_REFERENCE: {
            ...
            if (context.caller) {
                ...
                if (value === undefined && (keypath.length > 1 || !context.optionalVars)) {
                    console.log(context.caller.props);
