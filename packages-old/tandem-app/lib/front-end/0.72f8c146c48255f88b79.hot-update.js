...
exports.getAllGlobalStyles = utils_1.weakMemo(function (graph) {
    var styles = [];
    for (var filePath in graph) {
        var module_2 = graph[filePath].module;
        styles.push.apply(styles, module_2.globalStyles);
    }
    return styles;
});
exports.getComponentSourceUris = utils_1.weakMemo(function (graph) {
    var componentUris = {};
    for (var filePath in graph) {
        var module_3 = graph[filePath].module;
        for (var _i = 0, _a = module_3.components; _i < _a.length; _i++) {
            var component = _a[_i];
...
exports.getDependencyGraphComponentsExpressions = function (graph) {
    var templates = {};
    for (var filePath in graph) {
        var module_4 = graph[filePath].module;
        for (var _i = 0, _a = module_4.components; _i < _a.length; _i++) {
            var component = _a[_i];
...
exports.getComponentPreview = function (name, component) {
    return component.previews.find(function (preview) { return ast_1.getPCStartTagAttribute(preview, "name") === name; });
};
