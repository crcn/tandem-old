...
if (typeof document != "undefined") {
  (() => {
    ...
    style.textContent = "* {box-sizing:  border-box;} :root {--base:  2px;--base2:  4px;--base3:  6px;--base4:  8px;--base6:  10px;--base8:  12px;--base10:  14px;--base11:  16px;--font-size-rg:  12px;--font-size-md:  18px;--font-size-lg:  24px;--font-size-sm:  8px;--font-color:  #777;--font-color-alt:  #999;--font-color-dim:  #CCC;--font-color-light:  rgba(255, 255, 255, 0.9);--font-color-invert:  rgba(255, 255, 255, 0.9);--background:  blue;--background-alt:  #F9F9F9;--border-color:  #ECECEC;--border-color-deep:  #D9D9D9;--background-accent:  #F4F4F4;--background-deep:  #E9E9E9;--background-bold:  #EFEFEF;--background-highlight:  #00B5FF;--background-overlay:  rgba(255, 255, 255, 0.7);} body, html {font-family:  Helvetica;margin:  0;padding:  0;font-size:  var(--font-size-rg);color:  var(--font-color);}"
