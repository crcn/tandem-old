...
var inferExprType = function (expr, context) {
    switch (expr.type) {
        ...
        case ast_1.BKExpressionType.OPERATION: {
            ...
            context = inferExprType(right, operator !== "===" ? setTypeLimit(newTypeLimit & ~(previousTypeLimit & InferenceType.OPTIONAL), "The right-hand side of an arithmetic operation must be " + exports.getPrettyTypeLabelEnd(context.typeLimit), context) : context);
            return context;
        }
