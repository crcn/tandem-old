    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                console.log(event.sourceEvent, event.sourceEvent.clientX, event.sourceEvent.pageX, event.sourceEvent.screenX, event.sourceEvent.nativeEvent.layerX, event.sourceEvent.nativeEvent.x, event.sourceEvent.nativeEvent.movementX);
