...
/***/ "./src/front-end/components/main/workspace/stage/artboards.tsx":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__("./src/front-end/components/main/workspace/stage/artboards.scss");
var VOID_ELEMENTS = __webpack_require__("./node_modules/void-elements/index.js");
var React = __webpack_require__("./node_modules/react/react.js");
var recompose_1 = __webpack_require__("./node_modules/recompose/es/Recompose.js");
var artboard_1 = __webpack_require__("./src/front-end/components/main/workspace/stage/artboard.tsx");
...
__export(__webpack_require__("./src/front-end/components/main/workspace/stage/artboard.tsx"));


 ;(function register() { /* react-hot-loader/webpack */ if (process.env.NODE_ENV !== 'production') { if (typeof __REACT_HOT_LOADER__ === 'undefined') { return; } /* eslint-disable camelcase, no-undef */ var webpackExports = typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__ : module.exports; /* eslint-enable camelcase, no-undef */ if (typeof webpackExports === 'function') { __REACT_HOT_LOADER__.register(webpackExports, 'module.exports', "/Users/crcn/Developer/work/tandem/public/packages/tandem-app/src/front-end/components/main/workspace/stage/artboards.tsx"); return; } /* eslint-disable no-restricted-syntax */ for (var key in webpackExports) { /* eslint-enable no-restricted-syntax */ if (!Object.prototype.hasOwnProperty.call(webpackExports, key)) { continue; } var namedExport = void 0; try { namedExport = webpackExports[key]; } catch (err) { continue; } __REACT_HOT_LOADER__.register(namedExport, key, "/Users/crcn/Developer/work/tandem/public/packages/tandem-app/src/front-end/components/main/workspace/stage/artboards.tsx"); } } })();
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/process/browser.js")))
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                doc = slim_dom_1.uncompressDocument([dependencyUris, compressedNode]);
...
function handleOpenExternalArtboardsRequested() {
    var artboardInfo, state, workspace, openedNewWindow, lastExistingArtboard, _loop_3, _i, artboardInfo_1, _a, componentId, previewName;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                ...
                _loop_3 = function (componentId, previewName) {
            ...
            case 3:
                ...
                return [5 /*yield**/, _loop_3(componentId, previewName)];
            case 4:
                _b.sent();
                _b.label = 5;
            case 5:
                ...
                return [3 /*break*/, 3];
            case 6:
                if (!(!openedNewWindow && lastExistingArtboard)) return [3 /*break*/, 8];
...
function handleDroppedOnEmptySpace(event) {
    var _a, pageX, pageY, state, componentId, workspace, mousePosition;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.put(actions_1.artboardCreated(state_1.createArtboard({
                        componentId: componentId,
                        previewName: null,
                        bounds: __assign({}, mousePosition, { right: mousePosition.left + aerial_browser_sandbox_1.DEFAULT_WINDOW_WIDTH, bottom: mousePosition.top + aerial_browser_sandbox_1.DEFAULT_WINDOW_HEIGHT })
                    })))];
            case 2:
                _b.sent();
                return [2 /*return*/];
...
exports.moveArtboardToBestPosition = function (artboard, state) {
    ...
    return __assign({}, artboard, { bounds: {
            left: bounds.right,
            top: bounds.top,
            right: bounds.right + exports.DEFAULT_ARTBOARD_SIZE.width + ARTBOARD_PADDING,
            bottom: bounds.top + exports.DEFAULT_ARTBOARD_SIZE.height
        } });
};
...
exports.getComponentPreview = function (componentId, previewName, state) { return __awaiter(_this, void 0, void 0, function () {
    var base, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                base = state.apiHost + "/components/" + componentId + "/preview";
                console.log((previewName ? base + "/" + previewName : base) + ".json");
                return [4 /*yield*/, fetch((previewName ? base + "/" + previewName : base) + ".json")];
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.json()];
            case 2: return [2 /*return*/, _a.sent()];
